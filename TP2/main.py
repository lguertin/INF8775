...
def neighbors(size, notes, cout):
    ...
    for _ in range (n_iterations):
        ...
        if rand_n > 0:
            cost_removed += cout[notes[rand_n - 1], best_d[rand_n - 1], notes[rand_n], best_d[rand_n]]
            cost_added += cout[notes[rand_n - 1], best_d[rand_n - 1], notes[rand_n], rand_d]
           
        if rand_n < size - 2:
            cost_removed += cout[notes[rand_n], best_d[rand_n], notes[rand_n + 1], best_d[rand_n + 1]]
